...
@process(
    ...
    label="DED Helical",
    icon="add-layer",
    requires=[{"type": "face", "label": "Deposition surface", "count": 1}],
    params=[
        {"id": "cylinder_radius", "type": "number", "default": 40.0,
         "unit": "mm", "label": "Cylinder radius"},
        {"id": "helix_pitch",     "type": "number", "default": 5.0,
         "unit": "mm/rev", "label": "Helix pitch"},
        {"id": "helix_turns",     "type": "number", "default": 4,
         "label": "Helix turns"},
        {"id": "wire_feed",       "type": "number", "default": 3000,
         "unit": "mm/min", "label": "Wire feed"},
        {"id": "travel_speed",    "type": "number", "default": 300,
         "unit": "mm/min", "label": "Travel speed"},
        {"id": "lead_angle",      "type": "number", "default": 10,
         "unit": "deg", "label": "Lead angle"},
        {"id": "max_tilt",        "type": "number", "default": 45,
         "unit": "deg", "label": "Max tilt", "hint": "before collision warn"},
    ],
    est_time=14.2,
    est_volume=6.8,
)
